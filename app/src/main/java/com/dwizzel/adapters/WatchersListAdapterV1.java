...
public class WatchersListAdapterV1 extends RecyclerView.Adapter<WatchersListAdapterV1.ViewHolder> {
    ...
    public WatchersListAdapterV1(ArrayList<WatcherModel> watchersList) {
        try {
    ...
    @Override
    public WatchersListAdapterV1.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
